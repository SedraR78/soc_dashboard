...
export function TerminalPage() {
  ...
  const [mission, setMission] = useState('intro');
  const [output, setOutput] = useState(['Welcome to SOC Terminal', '> Type "help" for commands\n']);
  ...
  submit        - Submit answer (if you found it!)`,
    ...
    ls: () => `drwxr-xr-x  user  staff  4096 Jun 28 19:00 .
...
Last updated: 28 Jun`,
  ...
  "timeout": 30000
    ...
    'grep -r "password" .': () => `.ssh/id_rsa.pub: password_hash=xxx
config.json: SECURITY_PASSWORD=CyberSecure2024!
.bashrc: # password stored securely`,
    nmap: () => `Starting Nmap scan on 192.168.1.0/24
...
5432/tcp  open   postgres`,
    netstat: () => `Active Internet connections (tcp only)
  ...
  return (
    <div style={{ minHeight: '100vh', background: 'linear-gradient(135deg, #0f172a 0%, #1e293b 100%)', padding: '40px 24px', fontFamily: "'Courier New', monospace" }}>
      <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
        ...
        <div style={{ background: '#0f172a', border: '2px solid #00ff9d', borderRadius: '8px', padding: '20px', marginBottom: '20px', minHeight: '400px', maxHeight: '500px', overflowY: 'auto', fontFamily: "'Courier New', monospace", color: '#00ff9d', fontSize: '13px', lineHeight: '1.6' }} ref={outputRef}>
          {mission === 'intro' && (
            <div>
